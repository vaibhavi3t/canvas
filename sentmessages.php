...
<body>
<body>
	<div style="background-image:url(img/background.jpg);height:100px;">
<?
...
?>
	...
	<div style="background-image:url(img/background.jpg)">
			...
			<div style="background-image:url(img/background.jpg);margin-left:280px;height:40px;">
				<p><a href="profile.php" id="cap"><?php echo $display['firstname']?> <?php echo $display['lastname']?></a> >> Messages</p>
			</div>
	</div>
